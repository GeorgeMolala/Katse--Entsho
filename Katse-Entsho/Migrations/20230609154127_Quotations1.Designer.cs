...
namespace Katse_Entsho.Migrations
{
    ...
    [Migration("20230609154127_Quotations1")]
    partial class Quotations1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Katse_Entsho.Models.Company", b =>
                {
            ...
            modelBuilder.Entity("Katse_Entsho.Models.Quote", b =>
                {
                    ...
                    b.HasIndex("Quote_LinkID");

                    b.ToTable("Quotes");
                });

            modelBuilder.Entity("Katse_Entsho.Models.Quote_Link", b =>
                {
                    b.Property<int>("Quote_LinkID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Quote_LinkID");

                    b.HasIndex("ProductID");

                    b.ToTable("Quote_Links");
                });

            modelBuilder.Entity("Katse_Entsho.Models.Request_Link", b =>
                {
                    b.Property<int>("Request_LinkID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("Request_LinkID");

                    b.HasIndex("ProductID");

                    b.ToTable("Request_Links");
                });

            modelBuilder.Entity("Katse_Entsho.Models.Request_Quote", b =>
                {
                    b.Property<int>("RequestID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Katse_Entsho.Models.Quote", b =>
                {
                    b.HasOne("Katse_Entsho.Models.Company", "Company")
                        .WithMany("Quotes")
                        .HasForeignKey("CompanyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Katse_Entsho.Models.Customer", "Customer")
                        .WithMany("Quotes")
                        .HasForeignKey("CustomerUserID");

                    b.HasOne("Katse_Entsho.Models.Quote_Link", "Quote_Link")
                        .WithMany()
                        .HasForeignKey("Quote_LinkID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Katse_Entsho.Models.Quote_Link", b =>
                {
                    b.HasOne("Katse_Entsho.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Katse_Entsho.Models.Request_Quote", b =>
                {
                    b.HasOne("Katse_Entsho.Models.Customer", null)
                        .WithMany("Request_Quotes")
                        .HasForeignKey("CustomerUserID");

                    b.HasOne("Katse_Entsho.Models.Product", null)
                        .WithMany("Request_Quotes")
                        .HasForeignKey("ProductID");
                });
